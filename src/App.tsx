...
const App: React.FC = () => {
  ...
  if (error) {
    return (
      <div className="min-h-[100dvh] bg-black text-white flex flex-col items-center justify-center p-6 text-center font-mono">
        <div className="border border-red-500 p-6 rounded bg-red-950/30 max-w-sm">
          <h2 className="text-xl font-bold mb-3 text-red-500">Initialization Failed</h2>
  ...
  if (!started) {
    return (
      <div className="min-h-[100dvh] bg-black text-white flex flex-col items-center justify-center p-8 font-mono">
        ...
        <div className="space-y-4 mb-12 text-sm text-gray-400 max-w-xs text-center border-l-2 border-cyan-500/50 pl-4">
          <p>1. Grant camera access.</p>
          <p>2. Show both hands to open portal.</p>
